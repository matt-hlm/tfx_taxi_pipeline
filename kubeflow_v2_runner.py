...
_OUTPUT_DIR = os.path.join('s3://minio.kubeflow:9000', configs.GCS_BUCKET_NAME)
...
_DATA_PATH = 's3://minio.kubeflow:9000/{}/tfx-template/data/taxi/'.format(configs.GCS_BUCKET_NAME)
